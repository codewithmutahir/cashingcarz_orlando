...
<html>
<head>
    <title>Offer Accepted - Next Steps for Your Vehicle</title>
</head>
<body>
<p>Dear <strong>{{ $customerName }}</strong>,</p>

<p>We are pleased to inform you that we have accepted your offer of $<strong>{{ $offerAmount }}</strong> for your
    vehicle, reference
    number <strong>{{ $referenceNumber }}</strong>.</p>
