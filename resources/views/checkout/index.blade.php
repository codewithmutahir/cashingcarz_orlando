            ...
            <div class="row clearfix mb-5 mt-5">
                <div class="col-md-8 mx-auto checkout_details">
                    ...
                    <form action="{{route('order.confirm')}}" method="post">
                        ...
                        <div class="group">
                            <table>
                                @php $photo=\App\Models\Picture::where('post_id',$post_details->id)->first(); @endphp
                                <tr>
                                    <td class="item-img"><img
                                                src="@if($photo){{asset('storage').'/'.$photo->filename}} @else {{asset('images/No-Image-Placeholder.png')}} @endif">
                                    </td>
                                    <td class="item-details">
                                        <span class="item-title">{{$post_details->title}}</span>
                                        @if($post_details->car_brand_id!=null)
                                            <span class="item-size">Brand: {{\App\Models\Brand::findorfail($post_details->car_brand_id)->value('name')}}</span>
                                        @endif
                                        <span class="item-qty">Quantity: 1</span>
                                    </td>
                                    <td class="item-price">${{$post_details->price}}</td>
                                </tr>
                            </table>
                        </div>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="font-size:17px;" class="item-price">${{$post_details->price}}</td>
                            <tr>
                        ...
                        <input type="hidden" name="post_id" id="" value="{{$post_details->id}}">
