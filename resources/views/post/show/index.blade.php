...
@section('head')
    <meta property="og:title" content="{{ data_get($post, 'title') }}" />
    <meta property="og:type" content="article" />
    <meta property="og:url" content="{{ url()->current() }}" />
    <meta property="og:image" content="{{ asset('storage/'.$post['image']) }}" />
    <meta property="og:description" content="{{ str_limit(data_get($post, 'description'), 150) }}" />
    <meta property="og:site_name" content="{{ config('app.name') }}" />
    <meta property="og:locale" content="{{ app()->getLocale() }}" />
    <meta name="twitter:card" content="summary_large_image" />
    <meta name="twitter:title" content="{{ data_get($post, 'title') }}" />
    <meta name="twitter:description" content="{{ str_limit(data_get($post, 'description'), 150) }}" />
