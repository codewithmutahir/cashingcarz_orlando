...
@section('content')
    ...
    <div class="promo-text-box">
        <i class="fas fa-user-friends fa-4x icon-color-1"></i>
        <h3><strong>Invite Your Friends</strong></h3>
        <p>
            Tell your friends about our platform and help them get started easily.
        </p>
    </div>
    <div class="promo-text-box">
        <i class="fas fa-gift fa-4x icon-color-2"></i>
        <h3><strong>Earn Rewards</strong></h3>
        <p>Get special rewards whenever your friends join and participate.</p>
    </div>
    <div class="promo-text-box">
        <i class="fas fa-share-alt fa-4x icon-color-3"></i>
        <h3><strong>Invite Others Easily</strong></h3>
        <p>Spread the word and invite people through your favorite way messages, email, or social apps.</p>
    </div>
</div>
