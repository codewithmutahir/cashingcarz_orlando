...
@section('content')
    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                        @foreach($suv_models as $key=>$auto_price)
                            @php $car=\App\Models\Category::where('id',$auto_price->category_id)->first();
                                $car_brand=\App\Models\Category::where('id',$car->parent_id)->first()
                            @endphp
                            <tr>
                                <td>{{$key+1}}</td>
                                <td>
                                ...
                                <td>
                                    <a href="javascript:void(0)"
                                       ...
                                       onclick="delete_modal('{{route('suv.model.destroy',$auto_price->id)}}')">
        ...
        <div class="col-md-4">
            <form action="{{route('suv.model.store')}}" method="POST" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <h5>Sports Utility Vehicle</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" name="car_branc" id="subcategorys"
