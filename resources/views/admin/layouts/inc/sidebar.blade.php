        ...
        <div class="scroll-sidebar">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('admin.accounts') }}" class="sidebar-link waves-effect waves-dark">
                            <i data-feather="dollar-sign" class="feather-icon"></i> <span
                                    class="hide-menu">{{ __('Accounts') }}</span>
                        </a>
                    </li>
                            <li class="sidebar-item {{ request()->is('admin/referrals') ? 'selected' : '' }}">
            <a href="{{ url('admin/referrals') }}" class="sidebar-link waves-effect waves-dark">
                <i data-feather="users" class="feather-icon"></i>
                <span class="hide-menu">{{ __('Referrals') }}</span>
            </a>
        </li>
        
        <li class="sidebar-item {{ request()->is('admin/withdrawals') ? 'selected' : '' }}">
            <a href="{{ url('admin/withdrawals') }}" class="sidebar-link waves-effect waves-dark">
                <i data-feather="credit-card" class="feather-icon"></i>
                <span class="hide-menu">{{ __('Withdrawals') }}</span>
            </a>
        </li>
        
        <li class="sidebar-item {{ request()->is('admin/offer-submissions') ? 'selected' : '' }}">
    <a href="{{ route('admin.offer.submissions') }}" class="sidebar-link waves-effect waves-dark">
        <i data-feather="mail" class="feather-icon"></i>
        <span class="hide-menu">{{ __('Offer Submissions') }}</span>
    </a>
</li>
                    ...
                    @if (
                        ...
                        <!--            </li>-->
                        <!--            <li class="sidebar-item">-->
                        <!--                <a href="{{route('yes.list')}}" class="sidebar-link">-->
                        <!--                    <i class="mdi mdi-adjust"></i>-->
                        <!--                    <span class="hide-menu">Sales Request</span>-->
                        <!--                </a>-->
                        <!--            </li>-->

                        <!--            <li class="sidebar-item">-->
                        <!--                <a href="{{route('no.list')}}" class="sidebar-link">-->
                        <!--                    <i class="mdi mdi-adjust"></i>-->
                        <!--                    <span class="hide-menu">Post Request</span>-->
                        <!--                </a>-->
                        <!--            </li>-->
                        <!--        @endif-->
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('price.settings') }}" class="sidebar-link waves-effect waves-dark">
                            <i data-feather="settings" class="feather-icon"></i> <span
                                    class="hide-menu">{{ __('Auto Price Settings') }}</span>
                        </a>
                    </li>
                    ...
                    <li class="sidebar-item">
                        <a href="{{ route('donate.list') }}" class="sidebar-link waves-effect waves-dark">
                            <i data-feather="list" class="feather-icon"></i>
                            <span class="hide-menu">{{ __('Donate List') }}</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a href="{{ route('donate.photo.gallery') }}" class="sidebar-link waves-effect waves-dark">
                            <i data-feather="package" class="feather-icon"></i>
                            <span class="hide-menu">{{ __('Donate Photo Gallery') }}</span>
                        </a>
                    </li>

                    {{--                    <li class="sidebar-item">--}}
                    {{--                        <a href="{{ route('suv.model') }}" class="sidebar-link">--}}
                    {{--                            <span class="hide-menu">{{ __('SUV Model List') }}</span>--}}
                    {{--                        </a>--}}
                    {{--                    </li>--}}

                    <li class="sidebar-item">
                        <a href="{{ route('brand') }}" class="sidebar-link waves-effect waves-dark">
                            <i data-feather="list" class="feather-icon"></i>
                            <span class="hide-menu">{{ __('Brand List') }}</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a href="{{ route('faq') }}" class="sidebar-link waves-effect waves-dark">
                            <i data-feather="list" class="feather-icon"></i>
                            <span class="hide-menu">{{ __('Faq List') }}</span>
                        </a>
                    </li>


                    <li class="sidebar-item">
                        <a href="{{ route('admin.blogpost') }}" class="sidebar-link waves-effect waves-dark">
                            <i data-feather="list" class="feather-icon"></i>
                            <span class="hide-menu">{{ __('Blog Post') }}</span>
                        </a>
                    </li>
