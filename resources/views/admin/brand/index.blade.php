    ...
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table">
                        ...
                        <tbody>
                        @foreach($brands as $key=>$auto_price)
                            <tr>
                                <td>{{$key+1}}</td>
                                <td>{{$auto_price->name}}</td>
                                <td><img style="width: 60px;height: 60px;object-fit: fill;"
                                         src="{{asset('storage').'/'.$auto_price->photo}}" alt=""></td>

                                <td>
                                    <a href="{{route('brand.edit',$auto_price->id)}}" class="btn btn-xs btn-primary">
                                        <i class="far fa-edit"></i>
                                        Edit
                                    </a>
                                    <a href="javascript:void(0)"
                                       class="btn btn-xs btn-danger" data-button-type="delete"
                                       onclick="delete_modal('{{route('brand.destroy',$auto_price->id)}}')">
        ...
        <div class="col-md-4">
            <form action="{{route('brand.store')}}" method="post" enctype="multipart/form-data">
                <div class="card">
                    <div class="card-header">
                        <h5>Create A New Car Brand</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Brand Name</label>
                            <input type="text" class="form-control mb-2" id="exampleInputEmail1"
                                   aria-describedby="emailHelp" name="name" placeholder="Enter Brand Name" required>
