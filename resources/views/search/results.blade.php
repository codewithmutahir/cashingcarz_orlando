...
@section('content')
    <div class="main-container co-search-results">
                    ...
                    <div class="category-list {{ config('settings.list.display_mode', 'make-grid') }}{{ ($contentColSm == 'col-md-12') ? ' noSideBar' : '' }}">
                        <div class="tab-box">
                            ...
                            <ul id="postType" class="nav nav-tabs add-tabs tablist" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a href="{!! request()->fullUrlWithoutQuery(['page', 'type']) !!}"
                                       class="nav-link{{ $aClass }}">
                                        {{ t('All Listings') }} <span
                                                class="badge badge-pill {!! $spanClass !!}">{{ data_get($count, '0') }}</span>
                                    </a>
                                </li>
                                @if (config('settings.single.show_listing_type'))
                                    @if (!empty($postTypes))
                            ...
                            <div class="tab-filter pb-2">
                                {{-- OrderBy Desktop --}}
                                <select id="orderBy" title="Search by price" class="niceselecter select-sort-by small"
                                ...
                                <li>
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-toggle"
                                           data-bs-toggle="dropdown">{{ __('Search by price') }}</a>
        ...
        <div class="container mb-3">
            <div class="card border-light text-dark bg-light mb-3">
                <div class="card-body text-center">
                    ...
                    <a href="{{route('get_offer')}}" class="btn btn-border btn-post btn-listing">
                        {{ t('start_now') }}
                    </a>
