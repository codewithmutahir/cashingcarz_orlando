...
Route::get('/account/posts/list', function () {
    throw new GoneHttpException(); // returns 410 Gone
});

Route::get('/account/posts/favourite', function () {
    throw new GoneHttpException(); // returns 410 Gone
});
...
Route::get('blog', [OrderController::class, 'blog_show'])->name('client.blog.show');
Route::get('blog/{slug}', [OrderController::class, 'single_blog'])->name('client.single.blog.show');
Route::put('admin/blogpost/{id}', [OrderController::class, 'update'])->name('admin.blogpost.update');
Route::put('/account/referral-code', [UserController::class, 'updateReferralCode'])->middleware('auth');
Route::get('/referrals', function () { return view('referrals.create');})->name('referrals.create');
...
Route::middleware(['auth'])->prefix('admin')->group(function () {
    ...
    Route::post('/referrals/{referral}/update-status', [\App\Http\Controllers\Admin\ReferralController::class, 'updateStatus'])->name('admin.referrals.updateStatus');
});
Route::middleware('auth')->group(function () {
    Route::get('/account/withdrawals', [WithdrawalController::class, 'index'])->name('withdrawals.index');
    Route::post('/account/withdrawals', [WithdrawalController::class, 'store'])->name('withdrawals.store');
});
Route::get('/admin/withdrawals', [\App\Http\Controllers\Admin\WithdrawalController::class, 'index'])->name('admin.withdrawals.index');
Route::post('/admin/withdrawals/{id}/approve', [\App\Http\Controllers\Admin\WithdrawalController::class, 'approve'])->name('admin.withdrawals.approve');
Route::post('/admin/withdrawals/{id}/reject', [\App\Http\Controllers\Admin\WithdrawalController::class, 'reject'])->name('admin.withdrawals.reject');
Route::middleware(['auth'])->group(function () {
    Route::get('/account/bank-details', [\App\Http\Controllers\BankDetailsController::class, 'edit'])->name('bank.edit');
...
})->name('title-guides.addison');

Route::get('/how-to-get-your-title-in-balch-springs', function () {
    return view('title-guides.title-guide-balch-springs');
})->name('title-guides.balch-springs');


Route::get('/how-to-get-your-title-in-carrollton', function () {
    return view('title-guides.title-guide-carrollton');
})->name('title-guides.carrollton');

Route::get('/how-to-get-your-title-in-cedar-hill', function () {
    return view('title-guides.title-guide-cedar-hill');
})->name('title-guides.cedar-hill');

Route::get('/how-to-get-your-title-in-combine', function () {
    return view('title-guides.title-guide-combine');
})->name('title-guides.title-guide-combine');

Route::get('/how-to-get-your-title-in-coppell', function () {
    return view('title-guides.title-guide-coppell');
})->name('title-guides.title-guide-coppell');

Route::get('/how-to-get-your-title-in-dallas', function () {
    return view('title-guides.title-guide-dallas');
})->name('title-guides.title-guide-dallas');

Route::get('/how-to-get-your-title-in-desoto', function () {
    return view('title-guides.title-guide-desoto');
})->name('title-guides.title-guide-desoto');

Route::get('/how-to-get-your-title-in-duncan', function () {
    return view('title-guides.duncan-title-guide');
})->name('title-guides.duncan');

Route::get('/how-to-get-your-title-in-farmers-branch', function () {
    return view('title-guides.title-guide-farmers-branch');
})->name('title-guides.farmers-branch');

Route::get('/how-to-get-your-title-in-ferris', function () {
    return view('title-guides.ferris-title-guide');
})->name('title-guides.ferris');

Route::get('/how-to-get-your-title-in-garland', function () {
    return view('title-guides.title-guide-garland');
})->name('title-guides.garland');


Route::get('/how-to-get-your-title-in-glenn-heights', function () {
    return view('title-guides.title-guide-glenn-heights');
})->name('title-guides.glenn-heights');

Route::get('/how-to-get-your-title-in-grand-prairie', function () {
    return view('title-guides.title-guide-grand-prairie');
})->name('title-guides.grand-prairie');

Route::get('/how-to-get-your-title-in-highlandpark', function () {
    return view('title-guides.title-guide-highlandpark');
})->name('title-guides.HighlandPark');

Route::get('/how-to-get-your-title-in-hutchins', function () {
    return view('title-guides.title-guide-hutchins');
})->name('title-guides.hutchins');

Route::get('/how-to-get-your-title-in-irving', function () {
    return view('title-guides.title-guide-Irving');
})->name('title-guides.Irving');

Route::get('/how-to-get-your-title-in-lancaster', function () {
    return view('title-guides.title-guide-LancasterPA');
})->name('title-guides.Lancaster');

Route::get('/how-to-get-your-title-in-lewisville', function () {
    return view('title-guides.title-guide-lewisville');
})->name('title-guides.lewisville');


Route::get('/how-to-get-your-title-in-mesquite', function () {
    return view('title-guides.title-guide-mesquite');
})->name('title-guides.mesquite');

Route::get('/how-to-get-your-title-in-oakcliff', function () {
    return view('title-guides.title-guide-oakcliff');
})->name('title-guides.oakcliff');

Route::get('/how-to-get-your-title-in-richardson', function () {
    return view('title-guides.title-guide-richardson');
})->name('title-guides.richardson');

Route::get('/how-to-get-your-title-in-rowlett', function () {
    return view('title-guides.title-guide-rowlett');
})->name('title-guides.rowlett');

Route::get('/how-to-get-your-title-in-seagoville', function () {
    return view('title-guides.title-guide-seagoville');
})->name('title-guides.seagoville');

Route::get('/how-to-get-your-title-in-sunnyvale', function () {
    return view('title-guides.title-guide-sunnyvale');
})->name('title-guides.sunnyvale');


Route::get('/how-to-get-your-title-in-cockrell-hill', function () {
    return view('title-guides.title-cockrell-hill');
})->name('title-guides.cockrell-hill');

    Route::get('/admin/offer-submissions', [OrderController::class, 'showOfferSubmissions'])->name('admin.offer.submissions');
