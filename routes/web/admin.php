...
use App\Http\Controllers\SuvModelController;
...
Route::middleware(['admin', 'clearance', 'banned.user', 'no.http.cache'])
    ->group(function () {
        Route::get('price/auto/update/settings', [ContactController::class, 'price_auto_update_settings'])->name('price.settings');
        Route::post('price/auto/update/settings/store', [ContactController::class, 'price_auto_update_settings_store'])->name('auto.price.setting.store');
        Route::get('price/auto/update/settings/edit', [ContactController::class, 'price_auto_update_settings_edit'])->name('auto.price.setting.edit');
        Route::post('price/auto/update/settings/update', [ContactController::class, 'price_auto_update_settings_update'])->name('auto.price.setting.update');
        Route::get('price/auto/update/settings/destroy/{id}', [ContactController::class, 'price_auto_update_settings_destroy'])->name('auto.price.setting.destroy');
        Route::get('donate/list/', [ContactController::class, 'donate_list'])->name('donate.list');
        Route::get('donate/list/destroy/{id}', [ContactController::class, 'donate_list_destroy'])->name('donate.list.destroy');
        Route::post('donate/list/phone/status', [ContactController::class, 'donate_list_phone_status'])->name('donate.list.phone.status');
        Route::post('donate/list/car/received/status', [ContactController::class, 'donate_list_car_received_status'])->name('donate.list.car.received.status');
        Route::get('donate/photo/gallery', [ContactController::class, 'donate_photo_gallery'])->name('donate.photo.gallery');
        Route::post('donate/photo/gallery/store', [ContactController::class, 'donate_photo_gallery_store'])->name('donate.photo.gallery.store');
        Route::get('donate/photo/gallery/edit', [ContactController::class, 'donate_photo_gallery_edit'])->name('donate.photo.gallery.edit');
        Route::get('donate/photo/gallery/update', [ContactController::class, 'donate_photo_gallery_update'])->name('donate.photo.gallery.update');
        Route::get('donate/photo/gallery/destroy/{id}', [ContactController::class, 'donate_photo_gallery_destroy'])->name('donate.photo.gallery.destroy');
        Route::get('suv/model', [SuvModelController::class, 'index'])->name('suv.model');
        Route::post('suv/model/store', [SuvModelController::class, 'store'])->name('suv.model.store');
        Route::get('suv/model/destroy/{id}', [SuvModelController::class, 'destroy'])->name('suv.model.destroy');
        ...
        Route::get('yes/list', [OrderController::class, 'yes_list'])->name('yes.list');
        Route::get('no/list', [OrderController::class, 'no_list'])->name('no.list');
        Route::get('all/accounts', [OrderController::class, 'accounts'])->name('admin.accounts');
        Route::get('blog/post', [OrderController::class, 'blog'])->name('admin.blogpost');
        Route::post('blog/post/store', [OrderController::class, 'blog_store'])->name('admin.blogpost.store');
        Route::get('blog/post/delete/{id}', [OrderController::class, 'blog_post_delete'])->name('admin.blogpost.destroy');
    });