...
class ShowController extends FrontController
{
	...
	public function index($postId)
	{
        ...
        // Replace dynamic values in the meta tags
        ...
        $og_image = asset('storage/' . data_get($post, 'image')); // Adjust this based on your image path logic
        $og_url = url()->current(); // Current page URL
        
        // Pass data to the view
        return view('listing.details', compact('post', 'og_title', 'og_description', 'og_image', 'og_url', 'title', 'description', 'keywords'));
