...
return [
    ...
    */
    ...
    'providers' => [
		...
		/*
		 * Spatie Backup requires ext-zip (ZipArchive). Apache on Windows sometimes runs without
		 * php_zip loaded even when CLI has it; skip registration until zip is available.
		 */
		...(extension_loaded('zip') ? [\Spatie\Backup\BackupServiceProvider::class] : []),
